var calendar = {
    ...
    init: function (s) {
        ...
        _c.push("<div id='calendar_head' class='calendar_head'><em class='calendaremL'>«</em><input id='_calyear' readOnly='true' type='text' value='" + currYea + "' /><input id='_calmod' readOnly='true' type='text' value='" + currMon + "' /><em class='calendaremR'>»</em>");
        _c.push(_yers.join(""));
        ...
        _div.setAttribute('style', "left:" + calLeft + "px;top:" + calTop + "px;z-index:100000" + calendar.config.zIndex + ";");
	    ...
	    // 点击日期,（通过判断dateipt元素是否存在来确定是否"异常日志页"，是的话回调...）
	    $( function(){
	        obj = document.getElementById("dateipt"); 
	        if (obj){  // 元素存在 
		    // 回调...
		    console.log('huidiao....')
		    getList(1)
